...
NE_ONTOLOGY = ["person", "family", "animal", "language", "nationality", "ethnic-group,regional-group",
               ...
               "palace", "hotel", "worship-place", "sports-facility", "market", "park", "zoo", "amusement-park",
               "event", "incident", "natural-disaster", "earthquake", "war", "conference,game", "festival", "product",
               "vehicle", "ship", "aircraft", "aircraft-type", "spaceship", "car-make", "work-of-art", "picture",
               "music", "show", "broadcast-program", "publication", "book", "newspaper", "magazine", "journal",
               "natural-object", "law", "treaty", "award", "food-dish", " disease", "dna-sequence", "gene", "pathway",
               "protein", "thing", "name"]
QUANT_ONTOLOGY = ["monetary-quantity", "distance-quantity", "area-quantity", "volume-quantity", "temporal-quantity",
                  ...
                  "score-quantity", "fuel-consumption-quantity", "seismic-quantity", "date-entity", "rate-entity"]